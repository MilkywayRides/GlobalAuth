...
public final class ActivityQrscanBinding implements ViewBinding {
  ...
  private ActivityQrscanBinding(@NonNull LinearLayout rootView, @NonNull Button btnBack,
      @NonNull Button btnScanQr, @NonNull TextView tvStatus) {
  ...
  public static ActivityQrscanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityQrscanBinding((LinearLayout) rootView, btnBack, btnScanQr, tvStatus);
    }
